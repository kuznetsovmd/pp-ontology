...
$(function () {
	...
	var tagInfos = ['compute', 'storage', 'network', 'database', 'application', 'dedicated cloud', 'SecurityPurpose', 'management-deployment', 'migration', 'EI', 'devcloud', 'enterprise-applications', 'communications', 'closedeconomy', 'IOT', 'solutions', 'devtool', 'price', 'others', 'video', 'UserSupport'];
	var colInfo = [
	  ...
	  ['database', 'EI'],
	  ['SecurityPurpose', 'devcloud', 'solutions']
	];
	var colInAccordion = [
	  ['compute', 'network', 'SecurityPurpose', 'management-deployment', 'EI', 'enterprise-applications', 'closedeconomy', 'IOT', 'devtool', 'price'],
