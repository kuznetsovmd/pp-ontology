...
def process_renpho():
    ...
    #         o.connection('activityIsInitiatedBy', o.individual('FirstParty')),
    #     ),
    #     children=(
    ...
    o.individual(
        ...
        [
            ...
            o.connection(
                ...
                o.individual('DataActivityPurpose',
    ...
    # make_evdnc(onto, o.individual('FirstParty'), 'From our customers and their payment card issuers.')
    # make_evdnc(onto, third_party, 'Our third-party service providers who process payments for us.')
    ...
    o.individual('DataCollectionActivity',
        '',
        [
            o.connection('activityIsInitiatedBy', o.individual('FirstParty')),
            *data,
    ...
    o.individual('DataSharingActivity',
        '',
        [
            o.connection('activityIsInitiatedBy', o.individual('FirstParty')),
            *data,
